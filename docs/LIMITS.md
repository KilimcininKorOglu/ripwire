...
(39 INDEXING, 41 OUTPUT, 37 BOUNDARY); the remaining 98 render `—`, which means NOT YET
...
One table for each of the 86 files that declare a cap — the 215 caps counted above, and no parameter.
