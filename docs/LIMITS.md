...
The `class` column below carries that answer where it is known. **113 of 211 caps are classified
(38 INDEXING, 40 OUTPUT, 35 BOUNDARY); the remaining 98 render `—`, which means NOT YET
