...
The `class` column below carries that answer where it is known. **111 of 209 caps are classified
(37 INDEXING, 39 OUTPUT, 35 BOUNDARY); the remaining 98 render `—`, which means NOT YET
