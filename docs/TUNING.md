...
`src/pageview.h` — discloses: `count_capped`, `findings_capped`, `hits_capped`, `importers_capped`, `modules_capped`, `symbols_capped` — probe value `800` — **2 verb(s) respond**
...
`src/pageview.h` — discloses: `count_capped`, `findings_capped`, `hits_capped`, `importers_capped`, `modules_capped`, `symbols_capped` — probe value `320` — **2 verb(s) respond**
...
`src/mcpverbs.h` — discloses: `blast_radius_capped`, `calledBy_capped`, `coboost_commits_capped`, `forgotten_capped`, `hits_capped`, `siblings_capped`, `terms_capped`, `unindexed_candidates_capped` — probe value `128` — **1 verb(s) respond**
...
`src/pageview.h` — discloses: `count_capped`, `findings_capped`, `hits_capped`, `importers_capped`, `modules_capped`, `symbols_capped` — probe value `320` — **1 verb(s) respond**
...
`src/situ.h` — discloses: `partners_capped`, `tests_capped`, `untested_capped` — probe value `64` — **1 verb(s) respond**
...
`src/pageview.h` — discloses: `count_capped`, `findings_capped`, `hits_capped`, `importers_capped`, `modules_capped`, `symbols_capped` — probe value `640` — **1 verb(s) respond**
