...
# 64 B serves 1 today; that arm pins order and disclosure only. The floor is 1, not 8, so a legitimate byte change
# to the rows does not trip it.
for pb in 64 2000; do
    minrows=0; [ "$pb" = 2000 ] && minrows=1
