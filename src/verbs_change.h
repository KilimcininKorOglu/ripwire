...
using RunCapture = rw::compat::RwProcessCapture;
...
{
    return rw::compat::rw_run_command_capture( cmd, timeoutSec,
                                                []( RunCapture& cap, const char* data, std::size_t byteCount )
                                                {
                                                    runCaptureAppend( cap, data, byteCount );
                                                } );
}
