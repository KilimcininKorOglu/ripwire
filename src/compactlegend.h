...
inline constexpr CompactCompletenessTerm kCompactAttributeReadings[] =
{
    ...
    { "order", "order=defuse: s rows ranked by def-use coverage (distinct sliceable locals on the line) desc, then line; not source order", false, "slice", MapHeaderRead::No, {}, "slice" },   // slice.h sliceDefUseRowOrder
