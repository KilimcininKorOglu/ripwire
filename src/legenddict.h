...
inline constexpr std::size_t kTermCount     = std::size( kCompactCompletenessTerms );
...
inline std::string_view entryBody( std::size_t id ) noexcept
{
    ...
    if( id < kForBase )     { return kCompactCompletenessTerms[ id - kTermBase ].reading; }
