...
// scanner lives here, in a leaf header whose only dependency is Diagnostics.h. Duplicating it was the
...
// opener. Measured before the fix: the sanitizer build aborted with exit 134 on that frame.
