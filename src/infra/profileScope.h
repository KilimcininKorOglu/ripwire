...
// never touches the registry, builds no call tree, and does not guard recursion:
// it just folds wall time into a caller-owned Accum read back numerically. Single-thread use.
// ============================================================================
struct Accum
{
    uint64_t ticks { 0 };
