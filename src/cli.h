...
inline constexpr char kHelpTail[] =
        ...
        "                               the symbol DEFINITIONS it ranks into its top-K, so a CEILING on the rows printed there\n"
        "                               (overload pairs collapse to one row) rather than the row count — and next= fetches them.\n"
