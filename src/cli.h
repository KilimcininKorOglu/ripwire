...
inline constexpr char kHelpHead[] =
        ...
        "                               MEASURED (t14-cleanup #8, revised): a ranking lens, never a grade. On ripwire's own\n"
        "                               history at the pinned v0.6.2 tag (412 function pairs, mined from 80\n"
        "                               refactor/simplify/cleanup commits) the order between two versions of a function\n"
        "                               followed the sign of its token-count change in 96.0% of pairs (388/404 whose token\n"
        "                               count changed); Halstead\n"
        "                               volume was the driver behind 91.1% of the pairs where the order ran opposite the\n"
        "                               commit's implied direction (154/412, 37.4% ran the commit's own direction). Read a\n"
        "                               move as more or fewer tokens, not as more or less readable. First recorded as 484\n"
        "                               pairs / 30.2% from an unpinned, every-ref git-log walk that does not reproduce — see\n"
        "                               docs/EVALS.md §8 and docs/research/readability-construct-validity.md §3a/§3c\n"
        "                               (lane/research-readability-validity @9aecbc96). Do not read a low posnett= as proof a\n"
        "                               function needs work.\n"
