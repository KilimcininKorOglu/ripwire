...
inline constexpr char kHelpHead[] =
        ...
        "                               checked against human judgement of readability. Our own proxy measurement — 412 matched\n"
        ...
        "                               37.4% of pairs (154 of 412), which is worse than chance and suggests the ranking may run\n"
        "                               backwards more often than not. That population is pinned to the v0.6.2 tag, never a walk\n"
        "                               of every branch in the clone, so it cannot drift when an unrelated branch is pushed. Treated here\n"
        "                               as a signal to weigh, never a verdict; do not read a low posnett= as proof a function needs work.\n"
