...
inline constexpr char kHelpHead[] =
        ...
        "                               backwards more often than not. That population is pinned to the v0.6.2 tag, never\n"
        "                               `git log --all`, so it cannot drift when an unrelated branch is pushed. Treated here as a\n"
        "                               signal to weigh, never a verdict; do not read a low posnett= as proof a function needs work.\n"
