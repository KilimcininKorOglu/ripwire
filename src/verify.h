...
inline constexpr const char* kVerifyLegend =
    ...
    "graph_ambiguous=/graph_unresolved= beside it are the whole graph's resolver gauge (calls split over several defs / calls whose "
    "in-repo defs were all language-filtered), the map header's ambiguous=/unresolved=. "
