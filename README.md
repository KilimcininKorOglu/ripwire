...
<details>
<summary><b>625 gate scripts</b>, five contracts no unit test can hold, and the house rule: write the gate before the code it measures</summary> <!-- gatecount -->

`test/regression.sh` names **625 gate scripts** and is the authoritative list; <!-- gatecount -->
