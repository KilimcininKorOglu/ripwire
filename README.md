...
Around the core sit 182 long flags advertised in `--help`, across seven families — plus an MCP
...
<details>
<summary><b>644 gate scripts</b>, five contracts no unit test can hold, and the house rule: write the gate before the code it measures</summary> <!-- gatecount -->

`test/regression.sh` names **644 gate scripts** and is the authoritative list; <!-- gatecount -->
...
The `--help` output groups 182 long flags advertised in `--help` into seven families. The `--help=`
