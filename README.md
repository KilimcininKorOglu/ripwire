...
<details>
<summary><b>624 gate scripts</b>, five contracts no unit test can hold, and the house rule: write the gate before the code it measures</summary> <!-- gatecount -->

`test/regression.sh` names **624 gate scripts** and is the authoritative list; <!-- gatecount -->
...
Another gate derives the cap inventory. The tool has 217 compile-time caps and 7 ranking parameters.
